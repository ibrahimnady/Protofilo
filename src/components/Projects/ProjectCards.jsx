      ...
      <Card.Body>
        ...
        <div className="d-flex flex-column flex-xl-row gap-2 justify-content-center">
          ...
          {!props.isBlog && props.demoLink && (
            <Button variant="primary" href={props.demoLink} target="_blank"  className="ms-md-2 mt-2 mt-md-0">
              <CgWebsite /> &nbsp;
              {"Demo"}
            </Button>
          )}
          {!props.isBlog && props.ReportLink && (
            <Button variant="primary" href={props.ReportLink} target="_blank"  className="ms-md-2 mt-2 mt-md-0">
              <TbReportAnalytics /> &nbsp;
              {"Report"}
            </Button>
          )}
